...
# nsys_run_cmd="${run_cmd}"
# nsys_run_cmd="nsys profile -s none --stats=true -t nvtx,cuda,cudnn,cublas -o /lustre/fsw/coreai_devtech_all/pingtianl/a2a_olp/github/tests/unit_tests/a2a_overlap/profile_a2a_overlap.nsys-rep  --force-overwrite true --capture-range=cudaProfilerApi --capture-range-end=stop ${run_cmd}"
nsys_run_cmd="nsys profile -s none --stats=true -t nvtx,cuda,cudnn,cublas -o /lustre/fsw/coreai_devtech_all/pingtianl/a2a_olp/github/tests/unit_tests/a2a_overlap/profile_a2a_overlap.nsys-rep  --force-overwrite true --capture-range=cudaProfilerApi --capture-range-end=stop ${run_cmd}"
${nsys_run_cmd}