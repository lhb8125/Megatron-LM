...
def test_save_and_load_checkpoint_vp(create_args, tmp_path_dist_ckpt, tp_pp_vp, pp_layout, is_moe):
    ...
    set_tp_pp_vp(*tp_pp_vp, pp_layout=pp_layout, destroy_first=False)
