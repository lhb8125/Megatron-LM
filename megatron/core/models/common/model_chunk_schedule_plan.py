...
class TransformerLayerSchedulePlan:
    ...
    * mtp.mtp_post_process contains output_layer, mtp loss operations, whereas
    ...
    def set_fsdp_reshard_hooks(
        ...
        post_forward_hook,
        post_backward_hook,
        prepare_forward_module=None,
        prefetch_recompute_forward_parameters=None,
    ):
    ...
    def run(f_layer, b_layer, f_input=None, b_grad=None, is_last_layer_in_bwd=False):
        ...
        if f_layer is not None:
            ...
            # its recompute weights remain lazily resharded until backward uses
            # them; all other pairs operate on independent layer modules.
