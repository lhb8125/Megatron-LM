...
class DataParallelBuffer:
    ...
    def reduce_grad(self, overwrite_grad: bool = False):
        ...
        # A singleton group still has to copy or accumulate its temporary full
        # gradient into the persistent optimizer-facing shard. Only the NCCL
        # operation itself is redundant.
