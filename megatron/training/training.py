...
def training_log(
    ...
    if iteration % args.log_interval == 0:
        ...
        if report_memory_flag and iteration == 5:
    ...
    while iteration < args.train_iters:
        if args.profile and torch.distributed.get_rank() in args.profile_ranks and iteration == 3:
            try:
                ...
                memory_snapshot_path = f"/lustre/fsw/coreai_dlalgo_llm/users/hongbinl/pp_offloading/pyt_profile/{model_name}_{comment}"
