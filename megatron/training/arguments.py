        ...
        if args.megatron_fsdp_prefetch_recompute_forward_weights:
            ...
            if args.recompute_granularity == "full":
                ...
                assert args.recompute_granularity == "selective", (
                    ...
                    "mla_up_proj with --overlap-moe-expert-parallel-comm."
                )
...
def _add_distributed_args(parser):
    ...
    group.add_argument(
        ...
        action='store_true',
        default=False,
        help='Use registered same-offset staging outputs so transformer-unit dense '
        'inner-FSDP reduce-scatter can select NCCL symmetric kernels. Requires '
